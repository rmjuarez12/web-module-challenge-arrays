...
console.log("Does the array 'originalFlavors' has 31 flavors? ", is31Flavors(originalFlavors));
...
function addFlavor(newFlavor, flavors) {
  /*code here*/
  // Variable that will return the new array
  let newFlavorArr = flavors;

  // Add the new flavor to the array
  newFlavorArr.unshift(newFlavor);
